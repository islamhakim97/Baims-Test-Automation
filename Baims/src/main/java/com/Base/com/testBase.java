...
import com.Baims.util.WebListener;
...
public class testBase {
	...
	{
		prop=new Properties();
		FileInputStream fis= new FileInputStream("/Volumes/IslamHakim/AlgorizaTestAutomationInternship/FirstMonthProject/Baims Automation/Baims-Test-Automation/Baims/src/main/java/com/Baims/util/config.properties");
		prop.load(fis);
